...
const Methods = (key, api, ...args) => {
  ...
  if (api.debug) {
    ...
    console.info('method:', operations);
    console.info('headers:', api.api.headers);
    console.info('timeout:', timeoutInMilliseconds);
    console.info('body:', hasBody ? JSON.stringify(body) : undefined);
  }
